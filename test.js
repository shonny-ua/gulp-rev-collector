...
var htmlFileBody        = '<html><head><link rel="stylesheet" href="/css/style.css" /><script src="/js/script1.js"></script><script src="/js/script2.js"></script></head><body></body></html>';
...
it('should replace reved links in .html file with "replaceReved" param', function (cb) {
    ...
    stream.on('data', function (file) {
        ...
        assert(
            /script2\.js/.test(contents),
            'The JS#2 file name must not be replaced'
        );
